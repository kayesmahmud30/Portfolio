          ...
          {education.map((item, idx) => (
            ...
            >
              ...
              <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-start">
                <div>
                  <div className="text-sm font-semibold text-zinc-950 dark:text-zinc-50">{item.institution}</div>
                  <div className="mt-1 text-sm text-zinc-700 dark:text-zinc-200">{item.degree}</div>
                </div>
