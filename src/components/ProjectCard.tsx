        ...
        <div className="mt-5 flex flex-wrap items-center gap-3">
          ...
          {project.liveUrl ? (
            <a
              ...
              className="inline-flex items-center justify-center gap-1.5 rounded-full border border-black/10 bg-white/60 px-4 py-2 text-sm font-semibold text-zinc-900 backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/80 dark:border-white/10 dark:bg-zinc-900/40 dark:text-zinc-50 dark:hover:bg-zinc-900/60"
            >
              <span>Live Demo</span>
